package ru.mipt.acsl.geotarget.ui.controls.parameters.flightdevice;
    ...
    private class ArtificialHorizon extends Canvas
    {
        ...
        ArtificialHorizon()
        {
            ...
            deviceRegistry.activeDeviceProperty().addListener((activeDeviceProperty, oldActiveDevice, newActiveDevice) ->
            {
                ...
                {
                    oldActiveDevice.getMotionProperty().removeListener(motionUpdater);
                }
                if (newActiveDevice != null)
                {
                    newActiveDevice.getMotionProperty().addListener(motionUpdater);
                }
            });
            new AnimationTimer() {
