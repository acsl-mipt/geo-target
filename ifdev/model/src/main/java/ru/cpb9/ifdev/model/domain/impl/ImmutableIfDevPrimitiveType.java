 ...
 * @author Artem Shein
 */
public class ImmutableIfDevPrimitiveType extends AbstractImmutableIfDevType implements IfDevPrimitiveType
{
    @NotNull
    ...
    {
        return new ImmutableIfDevPrimitiveType(name, namespace, kind, bitLength, info);
    }
    ...
    {
        return new ImmutableIfDevPrimitiveType(name, namespace, kind, bitLength, Optional.ofNullable(info));
    }

    private ImmutableIfDevPrimitiveType(@NotNull Optional<IfDevName> name, @NotNull IfDevNamespace namespace,
                                        @NotNull IfDevType.TypeKind kind, long bitLength,
                                        @NotNull Optional<String> info)
    {
    ...
    {
        return String.format("IfDevPrimitiveType{name=%s, namespace=%s, kind=%s, bitLength=%s, info=%s}",
