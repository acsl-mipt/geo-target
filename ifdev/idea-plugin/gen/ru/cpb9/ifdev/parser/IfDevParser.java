...
public class IfDevParser implements PsiParser, LightPsiParser {
  ...
  public void parseLight(IElementType t, PsiBuilder b) {
    ...
    else if (t == ALL_PARAMETERS) {
      r = all_parameters(b, 0);
    }
    ...
    else if (t == DEEP_ALL_PARAMETERS) {
      r = deep_all_parameters(b, 0);
    }
  ...
  /* ********************************************************** */
  // STAR
  public static boolean all_parameters(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "all_parameters")) return false;
    if (!nextTokenIs(b, STAR)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, STAR);
    exit_section_(b, m, ALL_PARAMETERS, r);
    return r;
  }

  /* ********************************************************** */
  // LEFT_BRACKET type_application COMMA length_from (DOTS length_to)? RIGHT_BRACKET
  public static boolean array_type_application(PsiBuilder b, int l) {
    ...
    r = r && array_type_application_4(b, l + 1);
  ...
  // (DOTS length_to)?
  private static boolean array_type_application_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "array_type_application_4")) return false;
    array_type_application_4_0(b, l + 1);
    return true;
  }

  // DOTS length_to
  private static boolean array_type_application_4_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "array_type_application_4_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  /* ********************************************************** */
  // COMPONENT element_name_rule (COLON subcomponent_decl (COMMA subcomponent_decl)*)? info_string?
  ...
  // (COLON subcomponent_decl (COMMA subcomponent_decl)*)?
  ...
  private static boolean component_decl_2_0(PsiBuilder b, int l) {
    ...
    r = r && component_decl_2_0_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // (COMMA subcomponent_decl)*
  private static boolean component_decl_2_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "component_decl_2_0_2")) return false;
    int c = current_position_(b);
    while (true) {
      if (!component_decl_2_0_2_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "component_decl_2_0_2", c)) break;
      c = current_position_(b);
    }
    return true;
  }
  ...
  // COMMA subcomponent_decl
  private static boolean component_decl_2_0_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "component_decl_2_0_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, COMMA);
    r = r && subcomponent_decl(b, l + 1);
  ...
  private static boolean component_decl_5(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "component_decl_5")) return false;
  ...
  private static boolean component_decl_6(PsiBuilder b, int l) {
    ...
    int c = current_position_(b);
    while (true) {
      if (!component_decl_6_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "component_decl_6", c)) break;
      c = current_position_(b);
    }
    return true;
  }
  ...
  // command_decl|message_decl
  private static boolean component_decl_6_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "component_decl_6_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  /* ********************************************************** */
  // STAR DOT STAR
  public static boolean deep_all_parameters(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "deep_all_parameters")) return false;
    if (!nextTokenIs(b, STAR)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, STAR, DOT, STAR);
    exit_section_(b, m, DEEP_ALL_PARAMETERS, r);
    return r;
  }
  ...
  /* ********************************************************** */
  // deep_all_parameters | all_parameters | LEFT_PAREN parameter_decl (COMMA parameter_decl)* COMMA? RIGHT_PAREN
  public static boolean message_parameters_decl(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<message parameters decl>", LEFT_PAREN, STAR)) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<message parameters decl>");
    r = deep_all_parameters(b, l + 1);
    if (!r) r = all_parameters(b, l + 1);
    if (!r) r = message_parameters_decl_2(b, l + 1);
    exit_section_(b, l, m, MESSAGE_PARAMETERS_DECL, r, false, null);
    return r;
  }
  ...
  private static boolean message_parameters_decl_2(PsiBuilder b, int l) {
    ...
    r = r && message_parameters_decl_2_2(b, l + 1);
    r = r && message_parameters_decl_2_3(b, l + 1);
    r = r && consumeToken(b, RIGHT_PAREN);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  private static boolean message_parameters_decl_2_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "message_parameters_decl_2_2")) return false;
    int c = current_position_(b);
    while (true) {
      if (!message_parameters_decl_2_2_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "message_parameters_decl_2_2", c)) break;
      c = current_position_(b);
    }
    return true;
  }
  ...
  // COMMA parameter_decl
  private static boolean message_parameters_decl_2_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "message_parameters_decl_2_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, COMMA);
    r = r && parameter_decl(b, l + 1);
  ...
  // COMMA?
  private static boolean message_parameters_decl_2_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "message_parameters_decl_2_3")) return false;
    consumeToken(b, COMMA);
    return true;
  }
  ...
  /* ********************************************************** */
  // all_parameters | parameter_element info_string?
  public static boolean parameter_decl(PsiBuilder b, int l) {
    ...
    r = all_parameters(b, l + 1);
    if (!r) r = parameter_decl_1(b, l + 1);
  ...
  private static boolean parameter_decl_1(PsiBuilder b, int l) {
    ...
    r = r && parameter_decl_1_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // info_string?
  private static boolean parameter_decl_1_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "parameter_decl_1_1")) return false;
    info_string(b, l + 1);
    return true;
  }
