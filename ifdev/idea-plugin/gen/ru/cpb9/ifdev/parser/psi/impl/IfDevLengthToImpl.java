...
public class IfDevLengthToImpl extends ASTWrapperPsiElement implements IfDevLengthTo {

  public IfDevLengthToImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof IfDevVisitor) ((IfDevVisitor)visitor).visitLengthTo(this);
