...
public class IfDevAliasDeclImpl extends ASTWrapperPsiElement implements IfDevAliasDecl {

  public IfDevAliasDeclImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof IfDevVisitor) ((IfDevVisitor)visitor).visitAliasDecl(this);
