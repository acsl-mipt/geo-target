...
public interface IfDevTypes {
  ...
  IElementType ALL_PARAMETERS = new IfDevElementType("ALL_PARAMETERS");
  ...
  IElementType DEEP_ALL_PARAMETERS = new IfDevElementType("DEEP_ALL_PARAMETERS");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      else if (type == ALL_PARAMETERS) {
        return new IfDevAllParametersImpl(node);
      }
      ...
      else if (type == DEEP_ALL_PARAMETERS) {
        return new IfDevDeepAllParametersImpl(node);
      }
