...
public class IfDevLengthFromImpl extends ASTWrapperPsiElement implements IfDevLengthFrom {

  public IfDevLengthFromImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof IfDevVisitor) ((IfDevVisitor)visitor).visitLengthFrom(this);
