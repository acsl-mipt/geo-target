...
public class IfDevUnitDeclImpl extends ASTWrapperPsiElement implements IfDevUnitDecl {

  public IfDevUnitDeclImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof IfDevVisitor) ((IfDevVisitor)visitor).visitUnitDecl(this);
  ...
  public IfDevStringValue getStringValue() {
    return findChildByClass(IfDevStringValue.class);
  }
