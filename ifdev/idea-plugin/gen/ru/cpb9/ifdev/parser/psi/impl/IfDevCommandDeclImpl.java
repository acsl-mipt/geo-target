...
public class IfDevCommandDeclImpl extends ASTWrapperPsiElement implements IfDevCommandDecl {

  public IfDevCommandDeclImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof IfDevVisitor) ((IfDevVisitor)visitor).visitCommandDecl(this);
    else super.accept(visitor);
  }

  @Override
  @Nullable
  public IfDevCommandArgs getCommandArgs() {
    return findChildByClass(IfDevCommandArgs.class);
  }
