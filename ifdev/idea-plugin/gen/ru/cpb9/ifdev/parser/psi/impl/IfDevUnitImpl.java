...
public class IfDevUnitImpl extends ASTWrapperPsiElement implements IfDevUnit {

  public IfDevUnitImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof IfDevVisitor) ((IfDevVisitor)visitor).visitUnit(this);
